-- =====================================================
-- Migration 017: Template Restrictions & Auto-Save History (SAFE VERSION)
-- =====================================================
-- This is a safe version that checks for existing objects before creating them
-- Run this if you got errors about policies or tables already existing
-- =====================================================

-- =====================================================
-- STEP 1: Add template metadata table (IF NOT EXISTS)
-- =====================================================
...
-- Policy: Everyone can read templates (DROP IF EXISTS first)
DROP POLICY IF EXISTS "workflow_templates_select_policy" ON public.workflow_templates;
...
DROP POLICY IF EXISTS "workflow_templates_admin_policy" ON public.workflow_templates;
...
BEGIN
  ...
  ELSE
    RAISE NOTICE 'auto_saved column already exists on workflows table';
  END IF;
END $$;
...
-- Insert 3 starter-accessible templates (ON CONFLICT DO NOTHING to avoid duplicates)
...
-- =====================================================
-- STEP 6: Add indexes for performance (IF NOT EXISTS)
-- =====================================================
